...
public class calculadora extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        entrada.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 255)));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(entrada, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    this.numero1=Float.parseFloat(this.entrada.getText());
  this.Operador="/";
...
this.entrada.setText(this.entrada.getText()+"9");
  ...
  this.entrada.setText("");
    ...
    this.numero2=Float.parseFloat(this.entrada.getText());
  switch(this.Operador){
      case "+":this.entrada.setText (Float.toString(this.numero1+this.numero2));break;
      case "-":this.entrada.setText (Float.toString(this.numero1-this.numero2));break;
      case "/":this.entrada.setText (Float.toString(this.numero1/this.numero2));break;
      case "*":this.entrada.setText (Float.toString(this.numero1*this.numero2));break;
      case "%":this.entrada.setText (Float.toString(this.numero1%this.numero2));break;
